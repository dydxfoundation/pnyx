export enum DocumentationSublinks {
  ClaimRewards = '/dydx-governance/rewards/trading-rewards#how-do-i-claim-my-trading-rewards-when-can-i-withdraw-and-transfer-my-earned-dydx',
  LiquidityPool = '/dydx-governance/staking-pools/liquidity-staking-pool',
  SafetyPool = '/dydx-governance/staking-pools/safety-staking-pool',
  TradingRewards = '/dydx-governance/rewards/trading-rewards',
  Voting = '/dydx-governance/voting-and-governance/voting',
}
